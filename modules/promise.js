...
function Promise(g){if(!(g instanceof Function))throw f;var h=this;this.link=new Link;this[a]=c;initialize(this);try{g(function(g){resolve(g,h)},function(g){reject(g,h)})}catch(l){console.error(l)}}function Link(){this.reason=this["finally"]=this["catch"]=this.then=u}Promise.prototype["finally"]=function(g){this[a]!==c&&g();this.link["finally"]=g};Promise.prototype.then=function(g){this[a]===d&&(g(this[b]),initialize(this));this.link.then=g;return this};
